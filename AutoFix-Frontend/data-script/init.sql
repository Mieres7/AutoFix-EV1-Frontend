CREATE TABLE repair_discount (
    repair_discount_id INT PRIMARY KEY,
    gasoline_cost FLOAT,
    diesel_cost FLOAT,
    hybrid_cost FLOAT,
    electric_cost FLOAT
...
CREATE TABLE age_charge (
    age_charge_id INT PRIMARY KEY,
    sedan_charge FLOAT,
    hatchback_charge FLOAT,
    suv_charge FLOAT,
    pickup_charge FLOAT,
    van_charge FLOAT
);
...
CREATE TABLE kilometer_charge (
    kilometer_charge_id INT PRIMARY KEY,
    sedan_charge FLOAT,
    hatchback_charge FLOAT,
    suv_charge FLOAT,
    pickup_charge FLOAT,
...
CREATE TABLE repair_type_cost (
    repair_type_cost_id INT PRIMARY KEY,
